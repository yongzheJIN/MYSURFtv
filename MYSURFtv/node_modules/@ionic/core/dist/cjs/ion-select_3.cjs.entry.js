...
const ionicGlobal = require('./ionic-global-7f5ac4f7.js');
const helpers = require('./helpers-9038d758.js');
require('./hardware-back-button-2b00490e.js');
const overlays = require('./overlays-79a26af4.js');
...
const Select = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { onClick: this.onClick, role: "listbox", "aria-haspopup": "dialog", "aria-disabled": disabled ? 'true' : null, "aria-expanded": `${isExpanded}`, "aria-labelledby": labelId, class: {
                [mode]: true,
                'in-item': theme.hostContext('ion-item', el),
                'select-disabled': disabled,
            } }, index.h("div", { class: selectTextClasses, part: textPart }, selectText), index.h("div", { class: "select-icon", role: "presentation", part: "icon" }, index.h("div", { class: "select-icon-inner" })), index.h("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: disabled, ref: (btnEl => this.buttonEl = btnEl) })));
    }
