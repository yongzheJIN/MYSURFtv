...
const RefresherContent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: mode }, index.h("div", { class: "refresher-pulling" }, this.pullingIcon && hasSpinner &&
            ...
            index.h("div", { class: "refresher-pulling-text", innerHTML: index$3.sanitizeDOMString(this.pullingText) })), index.h("div", { class: "refresher-refreshing" }, this.refreshingSpinner &&
            index.h("div", { class: "refresher-refreshing-icon" }, index.h("ion-spinner", { name: this.refreshingSpinner })), this.refreshingText &&
            index.h("div", { class: "refresher-refreshing-text", innerHTML: index$3.sanitizeDOMString(this.refreshingText) }))));
    }
    get el() { return index.getElement(this); }
};
