...
const Chip = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: Object.assign(Object.assign({}, theme.createColorClasses(this.color)), { [mode]: true, 'chip-outline': this.outline, 'ion-activatable': true }) }, index.h("slot", null), mode === 'md' && index.h("ion-ripple-effect", null)));
    }
};
Chip.style = {
    ios: chipIosCss,
