import { C as CSS, p as plt, w as win, a as promiseResolve, d as doc, N as NAMESPACE } from './index-821f9ab1.js';
import { a as appGlobalScript } from './ionic-global-f538b4cf.js';
/*
...
var patchEsm = function () {
    ...
    if (!(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return import(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-55a133fe.js').then(function () {
...
var patchBrowser = function () {
    ...
    }
    {
        ...
        if (!win.customElements) {
            ...
            // @ts-ignore
            return import(/* webpackChunkName: "polyfills-dom" */ './dom-a1212707.js').then(function () { return opts; });
        }
    }
