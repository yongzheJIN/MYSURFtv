...
import { g as getIonPageElement } from './index-9b30ec44.js';
var DURATION = 540;
        ...
        enteringToolBarEls.forEach(function (enteringToolBarEl) {
            ...
            if (backDirection_1) {
                ...
                if (!translucentHeader) {
                    enteringToolBarBg.fromTo(OPACITY_1, 0.01, 'var(--opacity)');
                }
                else {
        ...
        if (leavingEl) {
            ...
            leavingToolBarEls.forEach(function (leavingToolBarEl) {
                ...
                if (backDirection_1) {
                    ...
                    var translucentHeader = parentHeader === null || parentHeader === void 0 ? void 0 : parentHeader.translucent;
                    if (!translucentHeader) {
                        leavingToolBarBg.fromTo(OPACITY_1, 'var(--opacity)', 0);
                    }
                    else {
