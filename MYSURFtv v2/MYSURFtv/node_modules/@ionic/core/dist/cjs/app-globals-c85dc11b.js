...
const patchEsm = () => {
    ...
    if ( !(index.CSS && index.CSS.supports && index.CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return Promise.resolve().then(function () { return require(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-8cd40e05.js'); }).then(() => {
...
const patchBrowser = () => {
    ...
    }
    {
        ...
        if ( !index.win.customElements) {
            ...
            // @ts-ignore
            return Promise.resolve().then(function () { return require(/* webpackChunkName: "polyfills-dom" */ './dom-d962f89e.js'); }).then(() => opts);
        }
    }
...
const globalScripts = ionicGlobal.appGlobalScript;
