...
const index$1 = require('./index-9c5fcdb7.js');
...
const Modal = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { "no-router": true, "aria-modal": "true", tabindex: "-1", class: Object.assign({ [mode]: true, [`modal-card`]: this.presentingElement !== undefined && mode === 'ios' }, theme.getClassMap(this.cssClass)), style: {
            ...
            }, onIonBackdropTap: this.onBackdropTap, onIonDismiss: this.onDismiss, onIonModalDidPresent: this.onLifecycle, onIonModalWillPresent: this.onLifecycle, onIonModalWillDismiss: this.onLifecycle, onIonModalDidDismiss: this.onLifecycle }, index.h("ion-backdrop", { visible: this.showBackdrop, tappable: this.backdropDismiss }), mode === 'ios' && index.h("div", { class: "modal-shadow" }), index.h("div", { tabindex: "0" }), index.h("div", { role: "dialog", class: "modal-wrapper ion-overlay-wrapper" }), index.h("div", { tabindex: "0" })));
    }
