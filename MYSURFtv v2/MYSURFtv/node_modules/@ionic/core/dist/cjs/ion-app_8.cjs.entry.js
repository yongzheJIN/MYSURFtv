    ...
    componentDidLoad() {
        {
            rIC(() => {
                ...
                if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-990b15cc.js'); }).then(module => module.startStatusTap());
                }
                if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
                    Promise.resolve().then(function () { return require('./input-shims-6ba71c3c.js'); }).then(module => module.startInputShims(ionicGlobal.config));
                }
                ...
                if (typeof window !== 'undefined') {
                    Promise.resolve().then(function () { return require('./keyboard-ccb1606f.js'); }).then(module => module.startKeyboardAssist(window));
                }
