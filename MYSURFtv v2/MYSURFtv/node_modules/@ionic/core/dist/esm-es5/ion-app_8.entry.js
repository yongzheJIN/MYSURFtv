...
import { r as registerInstance, h, H as Host, i as getElement, e as createEvent, f as readTask, j as forceUpdate, c as writeTask } from './index-821f9ab1.js';
import { b as getIonMode, c as config, i as isPlatform } from './ionic-global-f538b4cf.js';
import { c as clamp } from './helpers-5c745fbd.js';
import { t as transition } from './index-9b30ec44.js';
    ...
    App.prototype.componentDidLoad = function () {
        {
            rIC(function () {
                ...
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-9b3787f0.js').then(function (module) { return module.startStatusTap(); });
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    import('./input-shims-b956f530.js').then(function (module) { return module.startInputShims(config); });
                }
